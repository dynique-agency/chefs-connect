    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Wij verbinden je met <span className="text-gold italic">chefs en bediening</span>,<br className="md:hidden" /> snel en professioneel
            <br />
        ...
        >
          ...
          >
            ...
            <motion.div variants={buttonVariants} className="w-full sm:w-auto relative">
              ...
              <Link
                href="/zoek-personeel"
                className="group relative px-5 py-4 sm:px-6 md:px-7 lg:px-8 lg:py-5 font-inter text-[10px] xs:text-xs sm:text-sm lg:text-base uppercase tracking-[0.1em] sm:tracking-[0.12em] text-brown bg-gold border border-gold hover:bg-gold-dark hover:border-gold-dark transition-colors duration-300 overflow-hidden flex items-center justify-center w-full font-semibold"
                style={{ boxShadow: '0 4px 24px rgba(201,169,97,0.3), 0 1px 6px rgba(0,0,0,0.25)' }}
              >
