  ...
  return (
    <CityFreelancerPage
      ...
      faq={[
        ...
        { question: 'Werken jullie ook met medewerkers bediening in Hasselt?', answer: 'Ja. Of je nu medewerker bediening, gastheer, gastvrouw of leidinggevende bediening bent in Hasselt: we bemiddelen op alle niveaus en stemmen de opdracht af op jouw functie en ervaring.' },
      ]}
