...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Vacature Bediening in Hasselt | Chefs Connect',
    description,
    url,
...
const serviceSchema = {
  ...
  description: 'Freelance opdrachten voor bedieningsprofessionals bij restaurants en evenementen in Hasselt en Belgisch Limburg.',
...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Hebben jullie vacatures voor bediening in Hasselt?', acceptedAnswer: { '@type': 'Answer', text: 'Wij werken niet met losse vacatures. Je schrijft je één keer in en wij benaderen je zodra er een passende opdracht in Hasselt of de regio is. Zo hoef je niet eindeloos te solliciteren.' } },
    { '@type': 'Question', name: 'Wat voor opdrachten kan ik in de bediening verwachten in Hasselt?', acceptedAnswer: { '@type': 'Answer', text: 'Van fine dining restaurants en boetiekhotels tot grote evenementen, private dining en bruiloften in Hasselt en omstreken. We stemmen de opdrachten af op jouw ervaring en voorkeuren.' } },
    ...
    { '@type': 'Question', name: 'Werken jullie ook met medewerkers bediening in Hasselt?', acceptedAnswer: { '@type': 'Answer', text: 'Ja. Of je nu medewerker bediening, gastheer, gastvrouw of leidinggevende bediening bent in Hasselt: we bemiddelen op alle niveaus en stemmen de opdracht af op jouw functie en ervaring.' } },
  ],
};

export default function VacatureBedieningHasseltLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
