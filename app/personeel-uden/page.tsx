...
export default function PersoneelUdenPage() {
  return (
    <CityStaffingPage
      ...
      faq={[
        { question: 'Hoe snel kan Chefs Connect een kok voorstellen in Uden?', answer: 'In de meeste gevallen kunnen wij binnen 24 tot 48 uur een passende freelance kok voorstellen voor locaties in Uden en de regio Noordoost-Brabant.' },
        { question: 'Welke koks kunnen jullie voorstellen in Uden?', answer: 'Wij bemiddelen head chefs, plaatsvervangend keukenchefs, zelfstandig werkende koks en complete keukenbrigades voor restaurants, hotels en evenementenlocaties in Uden.' },
        { question: 'Is Chefs Connect ook actief buiten Uden?', answer: 'Ja, wij plaatsen ook in Den Bosch en de bredere regio Noordoost-Brabant.' },
      ]}
    />
  );
}
