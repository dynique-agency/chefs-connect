...
const url = siteUrl('https://chefs-connect.nl/vacature-kok-den-bosch');
const description = 'Op zoek naar werk als kok in Den Bosch? Werk als freelance kok bij de mooiste restaurants, hotels en events in Den Bosch en de regio Noordoost-Brabant.';
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Werken jullie ook met chefkoks of zelfstandig werkend koks in Den Bosch?', acceptedAnswer: { '@type': 'Answer', text: 'Ja. Of je nu chefkok, zelfstandig werkend kok, executive chef of hulpkok bent in Den Bosch: we bemiddelen op alle niveaus in de keuken en stemmen de opdracht af op jouw functie en ervaring.' } },
  ],
};
