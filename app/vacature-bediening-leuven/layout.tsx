...
export const metadata: Metadata = {
  title: 'Vacature Bediening Leuven? Werk als Freelancer',
  description,
  ...
  openGraph: {
    title: 'Vacature Bediening in Leuven | Chefs Connect',
    description,
    url,
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Werken jullie ook met medewerkers bediening in Leuven?', acceptedAnswer: { '@type': 'Answer', text: 'Ja. Of je nu medewerker bediening, gastheer, gastvrouw of leidinggevende bediening bent in Leuven: we bemiddelen op alle niveaus en stemmen de opdracht af op jouw functie en ervaring.' } },
  ],
};
