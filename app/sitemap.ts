...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages: Array<{
    ...
    { url: siteUrl('https://chefs-connect.nl/zeeland'), file: 'app/zeeland/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: siteUrl('https://chefs-connect.nl/personeel-amsterdam'), file: 'app/personeel-amsterdam/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-rotterdam'), file: 'app/personeel-rotterdam/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-den-haag'), file: 'app/personeel-den-haag/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-leuven'), file: 'app/personeel-leuven/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-mechelen'), file: 'app/personeel-mechelen/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-kortrijk'), file: 'app/personeel-kortrijk/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-oostende'), file: 'app/personeel-oostende/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-aalst'), file: 'app/personeel-aalst/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-sint-niklaas'), file: 'app/personeel-sint-niklaas/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-genk'), file: 'app/personeel-genk/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-middelburg'), file: 'app/personeel-middelburg/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-vlissingen'), file: 'app/personeel-vlissingen/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-goes'), file: 'app/personeel-goes/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    { url: siteUrl('https://chefs-connect.nl/personeel-groningen'), file: 'app/personeel-groningen/page.tsx', changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-amsterdam'), file: 'app/vacature-kok-amsterdam/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-amsterdam'), file: 'app/vacature-bediening-amsterdam/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-rotterdam'), file: 'app/vacature-kok-rotterdam/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-rotterdam'), file: 'app/vacature-bediening-rotterdam/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-den-haag'), file: 'app/vacature-kok-den-haag/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-den-haag'), file: 'app/vacature-bediening-den-haag/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-leuven'), file: 'app/vacature-kok-leuven/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-leuven'), file: 'app/vacature-bediening-leuven/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-mechelen'), file: 'app/vacature-kok-mechelen/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-mechelen'), file: 'app/vacature-bediening-mechelen/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-kortrijk'), file: 'app/vacature-kok-kortrijk/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-kortrijk'), file: 'app/vacature-bediening-kortrijk/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-oostende'), file: 'app/vacature-kok-oostende/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-oostende'), file: 'app/vacature-bediening-oostende/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-aalst'), file: 'app/vacature-kok-aalst/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-aalst'), file: 'app/vacature-bediening-aalst/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-sint-niklaas'), file: 'app/vacature-kok-sint-niklaas/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-sint-niklaas'), file: 'app/vacature-bediening-sint-niklaas/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-genk'), file: 'app/vacature-kok-genk/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-genk'), file: 'app/vacature-bediening-genk/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-middelburg'), file: 'app/vacature-kok-middelburg/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-middelburg'), file: 'app/vacature-bediening-middelburg/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-vlissingen'), file: 'app/vacature-kok-vlissingen/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-vlissingen'), file: 'app/vacature-bediening-vlissingen/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-goes'), file: 'app/vacature-kok-goes/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-goes'), file: 'app/vacature-bediening-goes/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-kok-groningen'), file: 'app/vacature-kok-groningen/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    { url: siteUrl('https://chefs-connect.nl/vacature-bediening-groningen'), file: 'app/vacature-bediening-groningen/page.tsx', changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: siteUrl('https://chefs-connect.nl/kennisbank/tips-freelance-bediening'), file: 'app/kennisbank/tips-freelance-bediening/page.tsx', changeFrequency: 'monthly', priority: 0.6 },
    { url: siteUrl('https://chefs-connect.nl/kennisbank/tips-freelance-kok-keuken'), file: 'app/kennisbank/tips-freelance-kok-keuken/page.tsx', changeFrequency: 'monthly', priority: 0.6 },
    { url: siteUrl('https://chefs-connect.nl/kennisbank/eerste-freelance-opdracht-checklist'), file: 'app/kennisbank/eerste-freelance-opdracht-checklist/page.tsx', changeFrequency: 'monthly', priority: 0.6 },
  ];
