  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const result = await submitToFormSubmit(formData, {
        subject: 'Chefs Connect: Aanvraag Keukenpersoneel Eindhoven',
      });
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center px-6 py-32">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Keukenbrigade aan het werk in een restaurant in Eindhoven"
            fill
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            Freelance kok nodig
            <br />
            <span className="text-gold italic">in Eindhoven?</span>
          </motion.h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              <span className="font-inter text-xs uppercase tracking-[0.3em] text-gold block mb-6">
                Eindhoven als horecastad
              </span>
              <h2 className="font-playfair text-4xl md:text-5xl font-light text-brown leading-tight mb-8">
                Een stad die sneller groeit
                <span className="text-gold italic"> dan haar personeelsmarkt</span>
              </h2>
              <div className="space-y-5 font-inter text-base md:text-lg text-brown-medium leading-relaxed">
                <p>
                  Eindhoven is de afgelopen jaren flink veranderd. De restaurantscene die voorheen bescheiden was heeft zich in hoog tempo ontwikkeld. Meer concepten, hogere verwachtingen van gasten. De stad trekt mensen aan die weten wat goed eten is en dat ook verwachten.
                </p>
                <p>
                  Tegelijkertijd is Eindhoven een drukke evenementenstad. Bedrijven in de Brainport-regio organiseren regelmatig bijeenkomsten waarbij catering een serieuze rol speelt. Rondom Strijp-S bruist het het hele jaar door. Dat maakt de vraag naar goed keukenpersoneel structureel, niet alleen bij calamiteiten.
                </p>
                <p>
                  Wij zijn actief in Eindhoven en plaatsen ook in Helmond, Tilburg en de bredere regio Noord-Brabant.
                </p>
              </div>
            </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              },
              {
                ...
                description: 'Staat jouw vraag hier niet tussen? Neem contact op. We denken graag mee over wat past.',
              },
            ].map((item, index) => (
              <motion.div
                key={item.title}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <h2 className="font-playfair text-4xl md:text-5xl font-light text-brown mb-8 leading-tight">
                Wij sturen je mensen
                <span className="text-gold italic"> die het aankunnen</span>
              </h2>
              <div className="space-y-5 font-inter text-base md:text-lg text-brown-medium leading-relaxed">
                <p>
                ...
                <p>
                  Wij sturen je geen mensen die misschien wel passen. Wij sturen je mensen waarvan wij zeker weten dat ze het aankunnen. Een druk restaurant in de Eindhovense binnenstad vraagt iets anders dan een bedrijfsevenement op een locatie buiten de stad. Dat verschil kennen wij.
                </p>
              </div>
            </motion.div>
          ...
          <div className="space-y-5">
            {[
              ...
              },
              {
                ...
                desc: 'We zoeken in ons netwerk naar de professional die het beste bij jouw keuken past. Niet wie toevallig beschikbaar is, maar wie er echt bij past.',
              },
              {
                step: '03',
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <input type="hidden" name="_location" value="Personeel Eindhoven" />
