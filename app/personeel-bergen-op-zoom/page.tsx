...
export default function PersoneelBergenOpZoomPage() {
  return (
    <CityStaffingPage
      ...
      faq={[
        { question: 'Hoe snel kan Chefs Connect een kok voorstellen in Bergen op Zoom?', answer: 'In de meeste gevallen kunnen wij binnen 24 tot 48 uur een passende freelance kok voorstellen voor locaties in Bergen op Zoom en de regio West-Brabant.' },
        { question: 'Welke koks kunnen jullie voorstellen in Bergen op Zoom?', answer: 'Wij bemiddelen head chefs, plaatsvervangend keukenchefs, zelfstandig werkende koks en complete keukenbrigades voor restaurants, hotels en evenementenlocaties in de historische binnenstad van Bergen op Zoom en daarbuiten.' },
