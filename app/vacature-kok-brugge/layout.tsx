...
const description = 'Op zoek naar werk als kok in Brugge? Werk als freelance kok bij de mooiste restaurants, hotels en events in Brugge en West-Vlaanderen.';
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Werken jullie ook met chefkoks of zelfstandig werkend koks in Brugge?', acceptedAnswer: { '@type': 'Answer', text: 'Ja. Of je nu chefkok, zelfstandig werkend kok, executive chef of hulpkok bent in Brugge: we bemiddelen op alle niveaus in de keuken en stemmen de opdracht af op jouw functie en ervaring.' } },
  ],
};
