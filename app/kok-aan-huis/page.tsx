  ...
  return (
    <EventLandingPage
      ...
      relatedLinks={[
        ...
        { href: '/kok-aan-huis-breda', label: 'Kok aan huis in Breda' },
        ...
        { href: '/kok-aan-huis-eindhoven', label: 'Kok aan huis in Eindhoven' },
        { href: '/kok-aan-huis-groningen', label: 'Kok aan huis in Groningen' },
        { href: '/kok-aan-huis-kerst', label: 'Kerstdiner aan huis' },
        { href: '/sommelier-inhuren', label: 'Sommelier voor uw evenement' },
        { href: '/barman-inhuren', label: 'Barman voor uw feest' },
