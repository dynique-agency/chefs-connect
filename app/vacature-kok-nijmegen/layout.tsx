...
const url = siteUrl('https://chefs-connect.nl/vacature-kok-nijmegen');
const description = 'Freelance kok worden in Nijmegen? Chefs Connect koppelt je aan opdrachten bij toprestaurants en hotels in Nijmegen en de regio Arnhem-Nijmegen.';
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Werken jullie ook met chefkoks of zelfstandig werkend koks in Nijmegen?', acceptedAnswer: { '@type': 'Answer', text: 'Ja. Of je nu chefkok, zelfstandig werkend kok, executive chef of hulpkok bent in Nijmegen: we bemiddelen op alle niveaus in de keuken en stemmen de opdracht af op jouw functie en ervaring.' } },
  ],
};
