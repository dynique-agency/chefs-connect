  ...
  return (
    <CityFreelancerPage
      ...
      faq={[
        ...
        { question: 'Werken jullie ook met medewerkers bediening in Bergen op Zoom?', answer: 'Ja. Of je nu medewerker bediening, gastheer, gastvrouw of leidinggevende bediening bent in Bergen op Zoom: we bemiddelen op alle niveaus en stemmen de opdracht af op jouw functie en ervaring.' },
      ]}
