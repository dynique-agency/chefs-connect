  ...
  return (
    <CityStaffingPage
      ...
      faq={[
        ...
        { question: 'Welke koks kunnen jullie leveren in Den Bosch?', answer: 'Wij bemiddelen head chefs, sous chefs, zelfstandig werkende koks en complete keukenbrigades voor restaurants, hotels en evenementenlocaties zoals de Brabanthallen in Den Bosch.' },
