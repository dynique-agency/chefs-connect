...
const description = 'Freelance kok worden in Brussel? Chefs Connect koppelt je aan opdrachten bij toprestaurants en hotels in Brussel en het Brussels Hoofdstedelijk Gewest.';
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Werken jullie ook met chefkoks of zelfstandig werkend koks in Brussel?', acceptedAnswer: { '@type': 'Answer', text: 'Ja. Of je nu chefkok, zelfstandig werkend kok, executive chef of hulpkok bent in Brussel: we bemiddelen op alle niveaus in de keuken en stemmen de opdracht af op jouw functie en ervaring.' } },
  ],
};
