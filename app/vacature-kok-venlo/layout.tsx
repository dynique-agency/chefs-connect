...
const url = 'https://chefs-connect.nl/vacature-kok-venlo';
...
export const metadata: Metadata = {
  ...
  description,
  keywords: ['vacature kok venlo', 'freelance kok venlo', 'zzp kok venlo', 'zelfstandig werkend kok venlo', 'kok vacatures venlo', 'horeca werk venlo'],
  alternates: pageAlternates(url),
  openGraph: {
    title: 'Werk als Freelance Kok in Venlo | Chefs Connect',
    description,
    url,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Kok in Venlo', item: url },
  ],
};
...
const serviceSchema = {
  ...
  description: 'Freelance opdrachten voor koks bij restaurants en evenementen in Venlo en Noord-Limburg.',
...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Hebben jullie vacatures voor koks in Venlo?', acceptedAnswer: { '@type': 'Answer', text: 'Wij werken niet met losse vacatures. Je schrijft je één keer in en wij benaderen je zodra er een passende opdracht in Venlo of de regio is. Zo hoef je niet eindeloos te solliciteren.' } },
    { '@type': 'Question', name: 'Wat voor opdrachten kan ik als kok verwachten in Venlo?', acceptedAnswer: { '@type': 'Answer', text: 'Van fine dining restaurants en boetiekhotels tot grote evenementen, private dining en bruiloften in Venlo en omstreken. We stemmen de opdrachten af op jouw ervaring en voorkeuren.' } },
...
export default function VacatureKokVenloLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
