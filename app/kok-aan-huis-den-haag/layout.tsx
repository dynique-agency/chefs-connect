...
const url = siteUrl('https://chefs-connect.nl/kok-aan-huis-den-haag');
const description = 'Boek een privéchef (private dining) in Den Haag: een romantisch diner, verjaardag of familiefeest, gekookt en geserveerd bij u thuis in Zuid-Holland.';

export const metadata: Metadata = {
  title: 'Privéchef Den Haag: Diner aan Huis',
  description,
  keywords: ['kok aan huis den haag', 'private dining den haag', 'privéchef den haag', 'chef aan huis den haag', 'diner aan huis den haag', 'privédiner den haag'],
  alternates: pageAlternates(url),
  openGraph: {
    title: 'Kok aan Huis Den Haag | Connect Events & Dining',
    description,
    url,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Den Haag', item: url },
  ],
};
...
const serviceSchema = {
  ...
  description: 'Een privéchef die bij u thuis een meergangendiner kookt en serveert, in Den Haag en de regio Zuid-Holland.',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Komen jullie ook buiten Den Haag zelf?',
      acceptedAnswer: { '@type': 'Answer', text: 'Ja, wij verzorgen kok-aan-huis-diners in heel Zuid-Holland, inclusief Wassenaar, Voorburg, Rijswijk en Delft.' },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Wat kost een kok aan huis in Den Haag?',
...
export default function KokAanHuisDenHaagLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
