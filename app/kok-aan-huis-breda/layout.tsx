...
const url = siteUrl('https://chefs-connect.nl/kok-aan-huis-breda');
const description = 'Boek een privéchef (private dining) in Breda: een romantisch diner, verjaardag of familiefeest, gekookt en geserveerd bij u thuis in West-Brabant.';

export const metadata: Metadata = {
  title: 'Privéchef Breda: Diner aan Huis',
  description,
  keywords: ['kok aan huis breda', 'private dining breda', 'privéchef breda', 'chef aan huis breda', 'diner aan huis breda', 'privédiner breda'],
  alternates: pageAlternates(url),
  openGraph: {
    title: 'Kok aan Huis Breda | Connect Events & Dining',
    description,
    url,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Breda', item: url },
  ],
};
...
const serviceSchema = {
  ...
  description: 'Een privéchef die bij u thuis een meergangendiner kookt en serveert, in Breda en de regio West-Brabant.',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Komen jullie ook buiten Breda zelf?',
      acceptedAnswer: { '@type': 'Answer', text: 'Ja, wij verzorgen kok-aan-huis-diners in heel West-Brabant, inclusief Oosterhout, Etten-Leur en Roosendaal, en ook richting de Efteling-regio en Tilburg.' },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Wat kost een kok aan huis in Breda?',
...
export default function KokAanHuisBredaLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
