...
export const metadata: Metadata = {
  ...
  description: 'Op zoek naar freelance horecapersoneel? Chefs Connect levert chefs en bediening snel, zonder gedoe — kwaliteit gegarandeerd voor uw restaurant of hotel in NL & BE.',
