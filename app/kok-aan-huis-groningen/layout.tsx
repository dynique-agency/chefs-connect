...
const url = siteUrl('https://chefs-connect.nl/kok-aan-huis-groningen');
const description = 'Boek een privéchef (private dining) in Groningen: een romantisch diner, verjaardag of familiefeest, gekookt en geserveerd bij u thuis in Noord-Nederland.';

export const metadata: Metadata = {
  title: 'Privéchef Groningen: Diner aan Huis',
  description,
  keywords: ['kok aan huis groningen', 'private dining groningen', 'privéchef groningen', 'chef aan huis groningen', 'diner aan huis groningen', 'privédiner groningen'],
  alternates: pageAlternates(url),
  openGraph: {
    title: 'Kok aan Huis Groningen | Connect Events & Dining',
    description,
    url,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Groningen', item: url },
  ],
};
...
const serviceSchema = {
  ...
  description: 'Een privéchef die bij u thuis een meergangendiner kookt en serveert, in Groningen en de regio Noord-Nederland.',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Komen jullie ook buiten Groningen zelf?',
      acceptedAnswer: { '@type': 'Answer', text: 'Ja, wij verzorgen kok-aan-huis-diners in de hele provincie Groningen en in de wijde regio Noord-Nederland, waaronder Friesland en Drenthe.' },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Wat kost een kok aan huis in Groningen?',
...
export default function KokAanHuisGroningenLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
