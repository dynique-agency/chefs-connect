...
const url = siteUrl('https://chefs-connect.nl/kok-aan-huis-amsterdam');
const description = 'Boek een privéchef (private dining) in Amsterdam: een romantisch diner, verjaardag of familiefeest, gekookt en geserveerd bij u thuis in Amsterdam en de regio.';

export const metadata: Metadata = {
  title: 'Privéchef Amsterdam: Diner aan Huis',
  description,
  keywords: ['kok aan huis amsterdam', 'private dining amsterdam', 'privéchef amsterdam', 'chef aan huis amsterdam', 'diner aan huis amsterdam', 'privédiner amsterdam'],
  alternates: pageAlternates(url),
  openGraph: {
    title: 'Kok aan Huis Amsterdam | Connect Events & Dining',
    description,
    url,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Amsterdam', item: url },
  ],
};
...
const serviceSchema = {
  ...
  description: 'Een privéchef die bij u thuis een meergangendiner kookt en serveert, in Amsterdam en de regio.',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Komen jullie ook buiten Amsterdam zelf?',
      acceptedAnswer: { '@type': 'Answer', text: 'Ja, wij verzorgen kok-aan-huis-diners in de hele regio Amsterdam, inclusief Amstelveen, Haarlem, Zaanstad en Almere, en op aanvraag ook daarbuiten.' },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Wat kost een kok aan huis in Amsterdam?',
...
export default function KokAanHuisAmsterdamLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
