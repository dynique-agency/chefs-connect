...
export default function KokAanHuisAmsterdamPage() {
  return (
    <EventLandingPage
      eyebrow="Connect Events & Dining · Amsterdam"
      heroLead="Een privéchef aan uw"
      heroAccent="tafel in Amsterdam"
      heroSubtext="Een compleet verzorgd diner bij u thuis in Amsterdam of de regio, gekookt door een ervaren chef. Voor een verjaardag, jubileum, romantisch etentje, of gewoon omdat het kan."
      introEyebrow="Fine dining, bij u thuis in Amsterdam"
      introHeadingLead="Sterrenkeuken in uw"
      introHeadingAccent="eigen keuken"
      introParagraphs={[
        'Amsterdam heeft een van de dichtste concentraties fine dining en sterrenrestaurants van Nederland, van de grachtengordel tot de Jordaan en De Pijp. Met een kok aan huis, ook wel private dining genoemd, haalt u diezelfde kwaliteit naar uw eigen keuken, zonder wachtlijst of maanden vooruit reserveren.',
        'Onze chef komt naar u toe, of u nu woont in een grachtenpand aan de Prinsengracht, een appartement in Oud-Zuid of een nieuwbouwwoning bij de Zuidas, en kookt live in uw keuken een menu dat is afgestemd op uw gezelschap en gelegenheid. U ontvangt uw gasten, wij verzorgen de rest.',
        'Amsterdam trekt bovendien een groot internationaal zakelijk en toeristisch publiek, van relaties op de Zuidas tot bezoekers die voor één avond hun hotelkamer verruilen voor een eigen tafel. Een privédiner aan huis maakt indruk zonder de formaliteit van een restaurant, en wij verzorgen kok-aan-huis-diners in Amsterdam en de regio, van Amstelveen tot Haarlem en Zaanstad.',
      ]}
      ...
      offerings={[
        ...
        { title: 'Zakelijk diner aan huis', description: 'Ontvang internationale relaties of collega’s rond de Zuidas met een persoonlijk diner in plaats van een restaurantreservering.' },
      ...
      faq={[
        ...
        {
          question: 'Komen jullie ook buiten Amsterdam zelf?',
          answer: 'Ja, wij verzorgen kok-aan-huis-diners in de hele regio Amsterdam, inclusief Amstelveen, Haarlem, Zaanstad en Almere, en op aanvraag ook daarbuiten.',
        },
        {
        ...
        {
          question: 'Wat kost een kok aan huis in Amsterdam?',
      ...
      formSubject="Connect Events & Dining: Aanvraag Kok aan Huis Amsterdam"
      formEventTypeDefault="Kok aan huis Amsterdam"
      formLocation="Kok aan huis Amsterdam"
      ...
      relatedLinks={[
        ...
        { href: '/kok-aan-huis-utrecht', label: 'Kok aan huis in Utrecht' },
