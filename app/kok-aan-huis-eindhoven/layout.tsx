...
const url = siteUrl('https://chefs-connect.nl/kok-aan-huis-eindhoven');
const description = 'Boek een privéchef (private dining) in Eindhoven: een romantisch diner, verjaardag of familiefeest, gekookt en geserveerd bij u thuis in de Brainportregio.';

export const metadata: Metadata = {
  title: 'Privéchef Eindhoven: Diner aan Huis',
  description,
  keywords: ['kok aan huis eindhoven', 'private dining eindhoven', 'privéchef eindhoven', 'chef aan huis eindhoven', 'diner aan huis eindhoven', 'privédiner eindhoven'],
  alternates: pageAlternates(url),
  openGraph: {
    title: 'Kok aan Huis Eindhoven | Connect Events & Dining',
    description,
    url,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Eindhoven', item: url },
  ],
};
...
const serviceSchema = {
  ...
  description: 'Een privéchef die bij u thuis een meergangendiner kookt en serveert, in Eindhoven en de Brainportregio.',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Komen jullie ook buiten Eindhoven zelf?',
      acceptedAnswer: { '@type': 'Answer', text: 'Ja, wij verzorgen kok-aan-huis-diners in de hele Brainportregio, waaronder Helmond, Veldhoven en Best, en de bredere regio Zuidoost-Brabant.' },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Wat kost een kok aan huis in Eindhoven?',
...
export default function KokAanHuisEindhovenLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
