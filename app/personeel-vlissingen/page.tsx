...
export default function PersoneelVlissingenPage() {
  return (
    <CityStaffingPage
      ...
      heroSubtext="Van strandpaviljoens op de Boulevard tot zakelijke catering rond de scheepswerven: wij leveren ervaren freelance koks op elk niveau. Snel geregeld, goed gescreend, zodat jij je keuken kunt draaien zoals het hoort."
      ...
      faq={[
        ...
        { question: 'Welke koks kunnen jullie leveren in Vlissingen?', answer: 'Wij bemiddelen head chefs, sous chefs, zelfstandig werkende koks en complete keukenbrigades voor restaurants, hotels en strandpaviljoens in Vlissingen.' },
