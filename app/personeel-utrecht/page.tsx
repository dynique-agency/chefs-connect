...
export default function PersoneelUtrechtPage() {
  return (
    <CityStaffingPage
      ...
      faq={[
        { question: 'Hoe snel kan Chefs Connect een kok voorstellen in Utrecht?', answer: 'In de meeste gevallen kunnen wij binnen 24 tot 48 uur een passende freelance kok voorstellen voor locaties in Utrecht.' },
        { question: 'Welke koks kunnen jullie voorstellen in Utrecht?', answer: 'Wij bemiddelen head chefs, plaatsvervangend keukenchefs, zelfstandig werkende koks en complete keukenbrigades voor restaurants, hotels en evenementenlocaties in Utrecht.' },
        { question: 'Is Chefs Connect ook actief buiten Utrecht?', answer: 'Ja, wij plaatsen ook in de bredere regio Midden-Nederland.' },
      ]}
    />
  );
}
