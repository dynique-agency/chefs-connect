...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Hoe snel kan Chefs Connect een kok voorstellen in Nijmegen?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Welke koks kunnen jullie voorstellen in Nijmegen?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Wij bemiddelen head chefs, plaatsvervangend keukenchefs, zelfstandig werkende koks en complete keukenbrigades voor restaurants, hotels en evenementenlocaties in Nijmegen.',
      },
    },
    {
      '@type': 'Question',
      name: 'Kan Chefs Connect ook tijdens drukke periodes zoals de Vierdaagse snel schakelen?',
      acceptedAnswer: {
        '@type': 'Answer',
