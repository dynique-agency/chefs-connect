  ...
  return (
    <CityFreelancerPage
      ...
      faq={[
        ...
        { question: 'Werken jullie ook met medewerkers bediening in Brugge?', answer: 'Ja. Of je nu medewerker bediening, gastheer, gastvrouw of leidinggevende bediening bent in Brugge: we bemiddelen op alle niveaus en stemmen de opdracht af op jouw functie en ervaring.' },
      ]}
