...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Tilburg', item: url },
  ],
};
...
const serviceSchema = {
  ...
  description: 'Een privéchef die bij u thuis een meergangendiner kookt en serveert, in Tilburg en de regio Midden-Brabant.',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Komen jullie ook buiten Tilburg zelf?',
      acceptedAnswer: { '@type': 'Answer', text: 'Ja, wij verzorgen kok-aan-huis-diners in heel Midden-Brabant, inclusief Goirle, Oisterwijk en Waalwijk.' },
    },
    {
      '@type': 'Question',
...
export default function KokAanHuisTilburgLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
