...
export const metadata: Metadata = {
  ...
  openGraph: { description: 'Werk als freelance chef of bedieningsprofessional op de mooiste horecalocaties in Maastricht en Zuid-Limburg. Chefs Connect verbindt je met opdrachten die bij je passen.' },
};
