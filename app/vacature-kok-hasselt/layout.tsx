...
const url = 'https://chefs-connect.nl/vacature-kok-hasselt';
const description = 'Op zoek naar werk als kok in Hasselt? Werk als freelance kok bij de mooiste restaurants en events in Hasselt en de grensregio.';
